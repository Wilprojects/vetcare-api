        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VeterinaryServiceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ScheduledStartUtc = table.Column<DateTime>(type: "datetime2(0)", precision: 0, nullable: false),
                    ScheduledEndUtc = table.Column<DateTime>(type: "datetime2(0)", precision: 0, nullable: false),
                    Price = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_VeterinaryServices_VeterinaryServiceId",
                        column: x => x.VeterinaryServiceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_Status_ScheduledStartUtc_ScheduledEndUtc",
                table: "Appointments",
                columns: new[] { "Status", "ScheduledStartUtc", "ScheduledEndUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_VeterinaryServiceId",
                table: "Appointments",
                column: "VeterinaryServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VeterinaryServices_IsActive",
                table: "VeterinaryServices",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_VeterinaryServices_Name",
                table: "VeterinaryServices",
                column: "Name",
                unique: true);
        }
